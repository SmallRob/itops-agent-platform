...
import portRackerRoutes from './routes/portRackerRoutes';
import portainerRoutes from './routes/portainerRoutes';
...
import { vncProxyService } from '@services/server';
...
import { startCircuitBreakerCleanup } from '@services/ai';
import { credentialService } from '@services/security';
import { healthService } from '@services/monitor';
import { backupService } from '@services/backup';
import { selfMonitorService } from '@services/monitor';
...
import { setServerInstances } from '@services/foundation';
import { checkDbskiterAvailability } from '@services/database';
import { timeoutApproval } from '@services/workflow';
import { queueService } from '@services/workflow';
...
app.use('/api/port-racker', rateLimiter, portRackerRoutes);
app.use('/api/portainer', rateLimiter, portainerRoutes);
app.use('/api/agent-service', rateLimiter, agentServiceRoutes);
